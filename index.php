		...
		<div class="row">
			<div class="col-md-2">
				<div class="sidebar sidebar-fixed" id="sidebar">
					<ul class="list-group">
						<li class="list-group-item"><a href="dashboard" class="active"><i class="fa fa-eye" aria-hidden="true"></i>Tài khoản</a>
						</li>
						...
						<li class="list-group-item"><a href="warehousing"><i class="fa fa-truck" aria-hidden="true"></i>Nhập/ xuất kho</a></li>
						<li class="list-group-item"><a href="stocktransfer"><i class="fa fa-truck" aria-hidden="true"></i>Tồn kho</a></li>
						<li class="list-group-item"><a href="dashboard"><i class="fa fa-file-text-o" aria-hidden="true"></i>Phiếu thu/ chi</a></li>
